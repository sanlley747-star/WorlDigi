...
(function () {
  ...
  var css = [
    ...
    '    background:rgba(2,6,23,.94);border-top:1px solid rgba(148,163,184,.18);color:#e5e7eb;align-items:center;justify-content:space-around;z-index:80;opacity:1;transition:opacity .25s ease;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);-webkit-tap-highlight-color:transparent;transform:translateZ(0);-webkit-transform:translateZ(0);will-change:transform}',
